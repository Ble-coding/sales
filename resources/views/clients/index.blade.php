											...
											<table class="table table-bordered text-nowrap" id="example1">
											   ...
											   @foreach($clients as $client)
												...
												<th scope="row">{{$client->id}}</th>
													<td>{{$client->nomcli}}</td>
													<td>{{$client->contactcli}}</td>
													<td>{{$client->sitgeocli}}</td>
													<td>
              											{{-- <a href="{{ route('clients.show', ['client' => $client->id])}}" class="btn btn-light">👁️</a> --}}
														  <a href="{{ route('clients.edit' , ['client' => $client->id]) }}" class="btn btn-light">✏️</a>
            										</td>
