							...
							<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Modification des informations de la vente {{ \Carbon\Carbon::parse($purchase->datepurchase)->format('d/m/Y')}}</h4>
									</div>
									<div class="card-body">
										<div class="row">
											<div class="col-lg-6 col-md-12">
                                                 {{-- @if(!session()->has('message')) --}}
												<form class="form-horizontal" action="{{ route('purchases.update', ['purchase' => $purchase->id]) }}" method="POST" enctype="multipart/form-data">
                                                   @method('PATCH')                                    
