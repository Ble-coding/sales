...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">informations sur le stock</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="{{route('stocks.show', ['stock' => $stock->id] )}}"><i class="fe fe-server mr-2 fs-14"></i>infos</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="{{route('stocks.show', ['stock' => $stock->id] )}}">{{$stock->id}}</a></li>
								</ol>
							</div>
