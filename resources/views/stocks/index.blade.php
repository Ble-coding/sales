...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Stocks</h4>
								<ol class="breadcrumb">
											...
											<table class="table table-bordered text-nowrap" id="example1">
											   ...
											   @foreach($stocks as $stock)
												...
												<th scope="row">{{$stock->id}}</th>
													...
													<td>
              											{{-- <a href="{{ route('stocks.show', ['stock' => $stock->id])}}" class="btn btn-light">👁️</a> --}}
														  <a href="{{ route('stocks.edit' , ['stock' => $stock->id]) }}" class="btn btn-light">✏️</a>
            										</td>
