...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Fournisseurs</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-list mr-2 fs-14"></i>Vue</a></li>
											...
											<table class="table table-bordered text-nowrap" id="example1">
											   ...
											   @foreach($fournisseurs as $fournisseur)
												...
												<th scope="row">{{$fournisseur->id}}</th>
													...
													<td>{{$fournisseur->contactfour}}</td>
													<td>{{$fournisseur->sitgeofour}}</td>
													<td>
              											{{-- <a href="{{ route('fournisseurs.show', ['fournisseur' => $fournisseur->id])}}" class="btn btn-light">👁️</a> --}}
														  <a href="{{ route('fournisseurs.edit' , ['fournisseur' => $fournisseur->id]) }}" class="btn btn-light">✏️</a>
            										</td>
