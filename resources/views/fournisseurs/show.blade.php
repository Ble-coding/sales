...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">informations sur le fournisseur</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="{{route('fournisseurs.show', ['fournisseur' => $fournisseur->id] )}}"><i class="fe fe-server mr-2 fs-14"></i>infos</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="{{route('fournisseurs.show', ['fournisseur' => $fournisseur->id] )}}">{{$fournisseur->id}}</a></li>
								</ol>
							</div>
                                    ...
                                    <div class="card-body">
										<blockquote class="blockquote mb-0">
											<footer class="blockquote-footer">
												{{$fournisseur->nomfour}} - {{$fournisseur->contactfour}} 
											</footer>
										</blockquote>
									</div>
									<div class="card-body">
