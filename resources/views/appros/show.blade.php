...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">informations sur l'approvisionnement</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="{{route('appros.show', ['appro' => $appro->id] )}}"><i class="fe fe-server mr-2 fs-14"></i>infos</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="{{route('appros.show', ['appro' => $appro->id] )}}">{{$appro->id}}</a></li>
								</ol>
							</div>
                                    ...
                                    <div class="card-body">
										  <blockquote class="blockquote mb-0">
											<footer class="blockquote-footer">
												{{$appro->stock->libelle}} - {{$appro->quantity}}
											</footer>
										</blockquote>
									</div>
									<div class="card-body">
										<blockquote class="blockquote mb-0">
											<p>{{$appro->fournisseur->nomfour}}</p>
										</blockquote>
									</div>
                                    <div class="card-body">
										<blockquote class="blockquote mb-0">
											<footer class="blockquote-footer">
												{{$appro->produit->marque}} - {{$appro->produit->model}} 
											</footer>
										</blockquote>
									</div>
                                       <div class="card-body">
